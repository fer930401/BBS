                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Fecha:</label>
                            <asp:TextBox ID="txtFecha" runat="server" TextMode="DateTimeLocal" CssClass="form-control" TabIndex="1"></asp:TextBox>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtNumEmpleado" runat="server" CssClass="form-control" OnTextChanged="txtNumEmpleado_TextChanged" AutoPostBack="true" TabIndex="2"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>Nombre del Coordinador:</label>
                            <asp:TextBox ID="txtCoordinador" runat="server" CssClass="form-control" TabIndex="5"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>Regla:</label>
