<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebAppBBS.Login" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <br />
            <img src="Images/dhl_supplychain_rgb.png" width="100%" height="150" />
            <br />
            <br />
